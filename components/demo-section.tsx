    ...
    <section className="container" id="demo">
      <div className="text-center mb-12">
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto">
          See how Finverse analyzes Tesla's Q4 2024 10-K and recent news
        </p>
      </div>
            ...
            <CardContent>
              <div className="p-4 rounded-md bg-muted">
                <p className="font-mono text-sm">
                  "Tesla Q4 2024 10-K + last 7 days of Tesla news"
                </p>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    "Margins dropped 2%, questionable accounting on energy
                    segment. Red flag on inventory buildup. Cash burn
                    accelerating while competition intensifies in China and
                    Europe."
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    "HODL. Elon said 'we're just getting started.' Robotaxi
                    reveal coming in August could be huge. Reddit sentiment
                    still bullish despite recent dip."
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    "Reuters reported layoffs in charging division, CNBC bullish
                    on robotaxi potential. WSJ highlighted growing inventory
                    concerns. Twitter sentiment down 15% this week."
                  </p>
                </div>
              </div>
              ...
              <div className="mt-8 p-4 rounded-md border bg-muted/50">
                ...
                <p className="text-sm">
                  Team vote → 1 Sell, 1 Hold, 1 Buy, 1 Neutral
                </p>
