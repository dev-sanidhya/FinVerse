  ...
  const features = [
    {
      ...
      content:
        "Finverse uses cutting-edge AI to simulate hedge fund analysts, retail investors, and strategists. Agents debate and derive strategic insights from your inputs.",
    ...
    },
    {
      ...
      content:
        "Instead of instant suggestions, Finverse walks you through the debate journey. Each agent defends a viewpoint before voting on Buy, Hold, or Sell.",
    ...
    },
    {
      ...
      content:
        "Upload financial news, earnings transcripts, or even your portfolio. Finverse transforms raw text into contextual insights with multiple perspectives.",
    ...
    },
    {
      ...
      content:
        "Whether you're a retail trader or portfolio manager, Finverse tailors its output to match your style—simplifying the complex or adding deeper layers.",
    ...
    },
    {
      ...
      content:
        "Every interaction trains Finverse. With each debate, news article, and query, our multi-agent system adapts to market patterns and your preferences.",
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <CardHeader>
                ...
                <CardDescription className="text-base">
                  Finverse Pro unlocks advanced features including custom agent
              ...
              <CardContent className="flex items-center justify-center p-6">
                <div className="w-full max-w-xs p-6 rounded-lg border border-primary/20 bg-card text-center">
                  <div className="text-2xl font-bold mb-2">Finverse Pro</div>
