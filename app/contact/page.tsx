      ...
      <div className="relative bg-primary/5 border-b">
        <div className="container py-16">
          ...
          <p className="text-muted-foreground max-w-2xl text-lg">
            Have questions about Finverse? We'd love to hear from you.
          </p>
        </div>
      </div>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">contact@Finverse.ai</p>
                    <p className="text-muted-foreground">support@Finverse.ai</p>
                  </div>
                </div>
