            ...
            <Card className="border-primary/20 bg-primary/5 shadow-sm">
              <CardHeader>
                <CardTitle className="text-2xl">
                  Finverse: The Financial LLM War Room
                </CardTitle>
              ...
              <CardContent className="space-y-6 text-base">
                <p>
                  <strong>Finverse</strong> is a next-gen financial platform
                ...
                <p>
                  ...
                  pro, Finverse gives you an interactive space where AI agents
                ...
                <p>
                  Finverse isn't just analysis—it's a war room. Strategies
          ...
          <div className="lg:col-span-1 space-y-6">
            <Card className="border-primary/10 shadow-sm">
              ...
              <CardContent className="text-muted-foreground">
                Finverse leverages cutting-edge multi-agent LLM systems,
