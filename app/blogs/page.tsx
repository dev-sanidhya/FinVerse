...
const blogs = [
  {
    ...
    description:
      "Explore how Finverse's multi-agent LLMs simulate hedge fund-style debates to evaluate market-moving news and earnings.",
  ...
  },
  {
    ...
    description:
      "See how Finverse's War Room handles real-time market scenarios to generate actionable financial insights.",
  ...
  },
  {
    ...
    description:
      "Understand how Finverse transforms financial news and reports into structured trade strategies using LLMs.",
  ...
  {
    title: "Earnings Report Breakdown: How Finverse Extracts Alpha",
    description:
      "Learn how Finverse parses quarterly earnings to uncover signals that inform hedge fund-level decisions.",
  ...
  {
    title: "Finverse vs Bloomberg Terminal: A New Age of Intelligence",
    description:
      "A head-to-head comparison of Finverse's LLM agents with traditional financial data terminals.",
    slug: "Finverse-vs-bloomberg",
    category: "Comparison",
    readTime: "8 min read",
    date: "Mar 22, 2025",
  ...
  {
    title: "Behind the Scenes: How Finverse's LLM Agents Debate",
    description:
      ...
      <div className="relative bg-primary/5 border-b">
        <div className="container py-16">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h4 className="text-primary font-medium">Finverse Insights</h4>
          </div>
          ...
          <p className="text-muted-foreground max-w-2xl text-lg">
            ...
            strategy simulations, and how Finverse is revolutionizing
